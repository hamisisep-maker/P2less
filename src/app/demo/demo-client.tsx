        ...
        <div className="grid h-[640px] grid-rows-[minmax(0,1fr)] overflow-hidden rounded-3xl border border-line shadow-[var(--shadow-card-hover)] lg:grid-cols-[260px_1fr_280px]">
          ...
          <aside className="hidden flex-col gap-4 border-l border-black/5 bg-surface p-5 lg:flex">
            ...
            <div className="rounded-xl border border-line bg-surface-2 p-4 text-xs text-muted">
              ...
              The destination number (<b>{org.number}</b>) tells P2Less which organization and systems to use. Message a different org&apos;s number and you get that org, and only what you&apos;re authorized to see there.
            </div>
