  ...
  return (
    <form action={action} className="mt-6 space-y-4">
      <div>
        ...
        <input name="email" type="email" required defaultValue={accounts[0]?.email} className="mt-1 w-full rounded-xl border border-line bg-surface px-3.5 py-2.5 text-sm outline-none focus:border-accent" />
      </div>
      <div>
