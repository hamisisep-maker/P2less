...
// gradient (not flat black), an ambient background animation showing the
// SHAPE of a conversation round trip (not literal chat content — that read
// as too loud/foreground), and real attribution/version info instead of a
      ...
      <div className="relative hidden flex-col justify-between overflow-hidden bg-[linear-gradient(160deg,var(--color-accent-ink),var(--color-ink))] p-12 text-white lg:flex">
        ...
        <div className="relative max-w-md">
          <p className="text-lg font-medium leading-relaxed text-white/80">
            One number. One conversation. Every system behind it, answering as you.
          </p>
        </div>
