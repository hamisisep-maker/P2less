...
*Last updated: 2026-08-25 (Visa/Card via Stripe added — the third and last payment method on the invoice-centric engine, real hosted Checkout, real signature-verified webhook, KES decimal handling confirmed live). Update this doc (and push it) in the same round as any change that ships, closes an external item, or surfaces a new gap — don't let it go stale.*
