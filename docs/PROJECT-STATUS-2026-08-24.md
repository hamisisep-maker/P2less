...
*Last updated: 2026-08-25 (Paybill added to the invoice-centric payment engine — real invoice-reference matching, partial/concurrent-payment settlement, a real transaction-deadlock bug found and fixed live). Update this doc (and push it) in the same round as any change that ships, closes an external item, or surfaces a new gap — don't let it go stale.*
