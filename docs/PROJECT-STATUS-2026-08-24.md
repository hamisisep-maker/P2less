...
*Last updated: 2026-08-25 (invoice-centric paid-upgrade flow — real critical money bug found and fixed same day, live-verified end to end). Update this doc (and push it) in the same round as any change that ships, closes an external item, or surfaces a new gap — don't let it go stale.*
